...
class Order extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'date', 'status', 'customer_id');
	...
	public static function checkorder($status=0) {
    global $database;
    $date = $database->escape_value($date);
    $status = $database->escape_value($status);
