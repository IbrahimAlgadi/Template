...
<?php foreach($edit_accounts_reciveable as $emp): ?>
        <div class="w3-section">
          ...
          <input class="w3-input w3-border" type="date"  value="<?php echo $emp->end_date; ?>" name="end_date" required>
          <input class="w3-input w3-border" type="number"  value="<?php echo $emp->cheque_number; ?>" name="cheque_number" required>
          <input class="w3-input w3-border" type="date" value="<?php echo $emp->cheque_date; ?>" name="cheque_date" required>
...
<?php endforeach; ?>   
	...
	<div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <div class="w3-col m2">
		<a href="accounts_reciveable.php" class="w3-red w3-bar-item w3-button w3-round-medium w3-large w3-padding w3-block w3-section">Cancel</a>
        </div>
