...
<?php
	...
	$total_count = account_receiveable::count_all();
	...
	// for this page
	$sql = "SELECT * FROM account_receiveables ";
	$sql .= "LIMIT {$per_page} ";
	$sql .= "OFFSET {$pagination->offset()}";
	$account_receiveables = account_receiveable::find_by_sql($sql);
    $sql_all = "SELECT * FROM account_receiveables ";
    $all_account_receiveables = account_receiveable::find_by_sql($sql_all);;
...
<header class="w3-container w3-theme" style="padding:21px 32px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-bar">
   <a href="accounts_reciveables.php" class="w3-bar-item w3-button w3-round-medium">Home</a>
...
<!--RFC: Only Change the text and create the accounts_reciveable.php and put it inside the actions -->
      <form class="w3-container" action="actions/add/account_receiveable.php" method="POST">
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <div class="w3-col m7">
        <!--RFC: This button submits to accounts_reciveable.php -->
  ...
  <div id="id02" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom" style="max-width:100%">
      ...
      <div id="modal-data"  class="w3-col m12" style="">
        ...
        <!--RFC: This Foreach fill tha table with the graped data -->
            <?php foreach($all_account_receiveables as $emp): ?>
            <tr>
    ...
    <form action="account_receiveables.php" >
    ...
    <div class="w3-right w3-col m4">
        ...
        <select class="w3-select w3-border" style="float: left; width: 29%;" name="search_term">
            ...
            <!--RFC: you need to change the select tarm and the database name -->
                <?php
                   $sql = "SELECT name FROM account_receiveables;";
                   $result = account_receiveable::find_by_sql($sql);
                   //var_dump($result);
                   foreach($result as $op){
...
<br />
    ...
    <div class="w3-col m12" style="">
        ...
        ?>
            ...
            <?php foreach($account_receiveables as $emp): ?>
            <tr>
                <td><?php echo $emp->id; ?></td>
                <td><?php echo $emp->name; ?></td>
                <td><?php echo $emp->end_date; ?></td>
                ...
                <!--RFC: The edit button send the id to the edit_accounts_reciveable.php -->
                <a href="edit_account_receiveable.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-teal" title="Edit"><i class="fa fa-pencil"></i></a>    
                <!--RFC: The delete button submit the id to the delete_accounts_reciveable.php -->
                <a href="actions/delete/delete_account_receiveable.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-red" title="Delete" onclick="return confirm('Are you sure you want to delete account receiveable: <?php echo $emp->name?>?')"><i class="fa fa-trash"></i></a>
                <!--RFC: The print function grabs the data and open anothe page print_emplpyee.php from it you can print the table -->
                <a href="actions/print/print_account_receiveable.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-blue" title="Print"><i class="fa fa-print"></i></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
        </div>
	...
	if($pagination->total_pages() > 1) {
    	...
    	echo "<a href=\"account_receiveables.php?page=";
      ...
      echo "\" class=\"w3-bar-item w3-button\">&laquo;</a> "; 
		...
		for($i=1; $i <= $pagination->total_pages(); $i++) {
			if($i == $page) {
				...
				echo " <a href=\"account_receiveables.php?page={$i}\" class=\"w3-bar-item w3-button \">{$i}</a> "; 
			}
		}
