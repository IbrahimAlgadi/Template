...
<?php
    ...
    $sql_all = "SELECT * FROM expenses ";
    $all_expenses = expense::find_by_sql($sql_all);;
...
<header class="w3-container w3-theme" style="padding:21px 32px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-bar">
   <a href="expenses.php" class="w3-bar-item w3-button w3-round-medium">Home</a>
...
<!--RFC: Only Change the text and create the expense.php and put it inside the actions -->
      <form class="w3-container" action="actions/add/expense.php" method="POST">
        <div class="w3-section">
          <input class="w3-input w3-border" type="date" placeholder="Expense Date" name="expense_date" required>
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <div class="w3-col m7">
        <!--RFC: This button submits to expense.php -->
    ...
    <div class="w3-modal-content w3-animate-zoom" style="max-width:100%">
      ...
      <div id="modal-data"  class="w3-col m12" style="">
        ...
        <!--RFC: This Foreach fill tha table with the graped data -->
            <?php foreach($all_expenses as $emp): ?>
            <tr>
                <td><?php echo $emp->id; ?></td>
                <td><?php echo $emp->expense_date; ?></td>
    ...
    <div class="w3-col m12" style="">
        ...
        ?>
            ...
            <tr>
                ...
                <!--RFC: The edit button send the id to the edit_expense.php -->
                <a href="edit_expense.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-teal" title="Edit"><i class="fa fa-pencil"></i></a>    
                <!--RFC: The delete button submit the id to the delete_expense.php -->
                <a href="actions/delete/delete_expense.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-red" title="Delete" onclick="return confirm('Are you sure you want to delete expense: <?php echo $emp->id?> with amount <?php  echo $emp->amount;?>?')"><i class="fa fa-trash"></i></a>
                <!--RFC: The print function grabs the data and open anothe page print_emplpyee.php from it you can print the table -->
                <a href="actions/print/print_expense.php?id=<?php echo $emp->id?>" class="w3-button w3-button-small w3-blue" title="Print"><i class="fa fa-print"></i></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
        </div>
      ...
      echo "\" class=\"w3-bar-item w3-button\">&laquo;</a> "; 
		...
		for($i=1; $i <= $pagination->total_pages(); $i++) {
			if($i == $page) {
				...
				echo " <a href=\"expenses.php?page={$i}\" class=\"w3-bar-item w3-button \">{$i}</a> "; 
			}
		}
