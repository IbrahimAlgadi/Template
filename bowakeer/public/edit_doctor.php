...
<?php
    ...
    if ($_GET['id'] != ''){
        ...
        $edit_doctor = doctor::find_by_sql($sql);
    }else{
...
<header class="w3-container w3-theme" style="padding:21px 32px">
  <h1 class="w3-xlarge">Update Doctor</h1>
...
<?php endforeach; ?>   
	...
	<div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <div class="w3-col m2">
		<a href="doctors.php" class="w3-red w3-bar-item w3-button w3-round-medium w3-large w3-padding w3-block w3-section">Cancel</a>
        </div>
