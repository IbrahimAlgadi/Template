...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card-2" style="z-index:3;width:250px;  " id="mySidebar">
  ...
  <div>
    ...
    <div id="demo" class="w3-hide w3-animate-zoom">
	  ...
	  <a class="w3-bar-item w3-button bolded-bar-subitems" href="pharmacy.php">&nbsp;&nbsp;<i class="fa fa-wheelchair"></i> Pharmacy</a>	
	  <a class="w3-bar-item w3-button bolded-bar-subitems" href="auxiliary.php">&nbsp;&nbsp;&nbsp;<i class="fa fa-ellipsis-v"></i>      &nbsp;Auxiliary</a>
