...
<?php
	...
	$total_count = pharm_category::count_all();
	...
	// for this page
	$sql = "SELECT * FROM pharm_categories ";
	$sql .= "LIMIT {$per_page} ";
	$sql .= "OFFSET {$pagination->offset()}";
	$pharm_categories = pharm_category::find_by_sql($sql);
    $sql_all = "SELECT * FROM pharm_categories ";
    $all_pharm_categories = pharm_category::find_by_sql($sql_all);;
...
<header class="w3-container w3-theme" style="padding:21px 32px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-bar">
   <a href="pharm_categories.php" class="w3-bar-item w3-button w3-round-medium">Home</a>
...
<div class="w3-container" style="padding:32px;">
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-top" style="max-width:600px">
      ...
      <form class="w3-container" action="actions/add/pharm_category.php" method="POST">
  ...
  <div id="id02" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom" style="max-width:100%">
      ...
      <div id="modal-data"  class="w3-col m12" style="">
        ...
        ?>
            ...
            <?php foreach($all_pharm_categories as $cat): ?>
            <tr>
    ...
    <form action="pharm_categories.php" >
    ...
    <div class="w3-right w3-col m4">
        ...
        <select class="w3-select w3-border" style="float: left; width: 29%;" name="search_term">
            ...
            <datalist id="cusom-list">
                <?php
                   $sql = "SELECT Name FROM pharm_categories;";
                   $result = pharm_category::find_by_sql($sql);
                   //var_dump($result);
...
<br />
    ...
    <div class="w3-col m12" style="">
        ...
        ?>
            ...
            <?php foreach($pharm_categories as $cat): ?>
            <tr>
                <td><?php echo $cat->id; ?></td>
                <td><?php echo $cat->Name; ?></td>
                <td class="w3-center  w3-right">
                <a href="edit_pharm_category.php?id=<?php echo $cat->id?>" class="w3-button w3-button-small w3-teal" title="Edit"><i class="fa fa-pencil"></i></a>    
                <a href="actions/delete/delete_pharm_category.php?id=<?php echo $cat->id?>" class="w3-button w3-button-small w3-red" onclick="return confirm('Are you sure you want to delete pharm_category: <?php echo $cat->id?>?')" title="Delete"><i class="fa fa-trash"></i></a>
                <a href="actions/print/print_pharm_category.php?id=<?php echo $cat->id?>" class="w3-button w3-button-small w3-blue" title="Print"><i class="fa fa-print"></i></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
        </div>
	...
	if($pagination->total_pages() > 1) {
    	...
    	echo "<a href=\"pharm_categories.php?page=";
      ...
      echo "\" class=\"w3-bar-item w3-button\">&laquo;</a> "; 
		...
		for($i=1; $i <= $pagination->total_pages(); $i++) {
			if($i == $page) {
				...
				echo " <a href=\"pharm_categories.php?page={$i}\" class=\"w3-bar-item w3-button \">{$i}</a> "; 
			}
		}
