...
<div class="w3-container" style="padding:32px;">
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="add/employee.php" method="POST">
...
<br />
  ...
  <td class="w3-center  w3-right"><a href="edit_employee.php?id=<?php echo $emp->Id?>" class="w3-button w3-button-small w3-teal" title="Edit"><i class="fa fa-pencil"></i></a> <a href="delete_employee.php?id=<?php echo $emp->Id?>" class="w3-button w3-button-small w3-red" title="Delete"><i class="fa fa-trash"></i></a> <a href="print_employee.php?id=<?php echo $emp->Id?>" class="w3-button w3-button-small w3-blue" title="Print"><i class="fa fa-print"></i></a></td>
  </tr>
      ...
      echo "\" class=\"w3-bar-item w3-button\">&laquo;</a> "; 
		...
		for($i=1; $i <= $pagination->total_pages(); $i++) {
			if($i == $page) {
				...
				echo " <a href=\"template.php?page={$i}\" class=\"w3-bar-item w3-button \">{$i}</a> "; 
			}
		}
